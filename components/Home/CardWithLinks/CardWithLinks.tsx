...
const CardWithLinks = () => (
  ...
  >
    <List
      subheader={
        <Typography pl={2} component='span' fontWeight={400} color='lightgray' variant='subtitle1'>
          Ссылки
        </Typography>
      }
    >
      ...
      <ListItem>
        ...
        <ListItemText
          ...
          secondary={
            <>
              <DefaultLink text='Бэк-энд' href='https://github.com/xi-effect/xieffect-backend' />
              <DefaultLink text='Фронт-энд' href='https://github.com/xi-effect/xieffect-front' />
              <DefaultLink text='Организация' href='https://github.com/xi-effect' />
            </>
          }
        />
      </ListItem>
      ...
      <ListItem>
        ...
        <ListItemText
          ...
          secondary={
            <>
              <DefaultLink href='https://xieffect.ru/' text='Сайт продакшн' />
              <DefaultLink href='https://xieffect.ru/' text='Сайт предпродакшн' />

              <Box pt={2} component='span' fontSize='16px' color='lightgray' display='inline-block'>
                <Box component='span' display='block'>
                  <Typography pr={1} component='span'>
                    Почта:
                  </Typography>
      ...
      <ListItem>
        ...
        <ListItemText
          ...
          secondary={
            <>
              <DefaultLink text='Miro' href='https://miro.com/app/board/o9J_lV8Vahk=/' />
              <DefaultLink
                text='Notion invite'
        ...
        <ListItemText
          ...
          secondary={
            <>
              ...
              />
              <DefaultLink text='Miro Design' href='https://miro.com/app/board/o9J_ljALvw4=/ ' />
            </>
          }
        />
      </ListItem>
