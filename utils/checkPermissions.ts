...
export const checkUserRole: CheckUserT<PermissionsUserRoleT> = (
  { sections, arg }) => !!sections.filter(p => p.name === arg).length;

export const checkUserPermissions: CheckUserT<PermissionsT> = (
  {
    sections, arg,
